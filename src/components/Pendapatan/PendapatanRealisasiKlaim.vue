<template>
    <div>
        ...
        <div class="kolom6 kolom12-m judul maLeft maLeft-m"><i class="fa fa-chart-bar"></i> Grafik Laporan Pendapatan Realisasi Klaim</div>
        <div class="kolom6 maLeft maLeft-m dateBorder"><date-picker v-model="time3" range :shortcuts="shortcuts" :lang="lang" class="TopDate"></date-picker></div>
...
<script>
const url = 'http://127.0.0.1:8000/api/pendpKlaim';// dokumen ada di API folder
